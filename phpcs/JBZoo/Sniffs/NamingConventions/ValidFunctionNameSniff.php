 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class JBZoo_Sniffs_NamingConventions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if ($methodProps['scope'] === 'private' || $methodProps['scope'] === 'protected') { // Fixed by SmetDenis
            $isPublic = false;
        } else {
            $isPublic = true;
        }
        ...
        if ($isPublic === false) {
            if ($methodName{0} !== '_') {
                $error = ucfirst($methodProps['scope']) . ' method name "%s" must be prefixed with an underscore';
