 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class JBZoo_Sniffs_Methods_CamelCapsMethodNameSniff extends Generic_Sniffs_NamingConventions_CamelCapsFunctionNameSniff
{
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if ($methodName !== '_' && PHP_CodeSniffer::isCamelCaps($testName, false, true, false) === false) {
